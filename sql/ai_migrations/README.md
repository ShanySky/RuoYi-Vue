...
Current predecessor for the first ordered migration is the repository's P0-before-Phase-3.5 published AI baseline.
Repository acceptance reproduces that baseline with `ai_20260918.sql` plus `ai_hardening_b1_b3_20260919.sql`.
Older environments must first apply the historical scripts required to reach that published baseline; Phase 3.5 does not invent or guess unsupported legacy upgrade chains.
