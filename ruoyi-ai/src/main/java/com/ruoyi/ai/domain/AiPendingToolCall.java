...
public class AiPendingToolCall {
 private Long pendingId,conversationId,userId,modelId,runId,pageVersion; private String callId,toolName,argumentsJson,riskLevel,modelCode,reasoningEffort,route,pageInstanceId,status; private Date createTime,expireTime,resolvedTime;
 ...
 public Long getRunId(){return runId;} public void setRunId(Long v){runId=v;} public String getRoute(){return route;} public void setRoute(String v){route=v;}
