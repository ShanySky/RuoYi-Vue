...
public class AiContextService {
 ...
 public AiCheckpoint maybeCompact(AiConversation conversation,AiRun run,AiModel model,String reasoningEffort) {
  ...
  AiPrompt system=prompts.require(AiPromptService.SYSTEM); int estimate=estimate(system.getContent(),latest==null?null:latest.getSummary(),recent);
