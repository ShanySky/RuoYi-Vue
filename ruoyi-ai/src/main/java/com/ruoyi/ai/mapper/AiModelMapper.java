...
public interface AiModelMapper
{
    ...
    @Insert("insert into ai_model(provider_id, model_code, display_name, enabled, default_model, tool_capability, reasoning_capability, reasoning_efforts, default_reasoning_effort, last_sync_time, create_by, create_time, remark) "
            + "values(#{providerId}, #{modelCode}, #{displayName}, #{enabled}, #{defaultModel}, #{toolCapability}, #{reasoningCapability}, #{reasoningEfforts}, #{defaultReasoningEffort}, #{lastSyncTime}, #{createBy}, sysdate(), #{remark})")
